...
| `feature.autoDetect.podCIDR`           | cni cluster used                                                                                                           | `calico`                |
| `feature.autoDetect.clusterCIDR`       | if ignore service ip                                                                                                       | `true`                  |
| `feature.autoDetect.nodeIP`            | if ignore node ip                                                                                                          | `true`                  |
