...
| `feature.vxlan.disableChecksumOffload`       | Disable checksum offload, set to true only when facing network connectivity issues. Please note that setting it to true may result in decreased network performance. | `false`                 |
...
| `agent.image.tag`                                    | The image tag of egressgateway agent, overrides the image tag whose default is the chart appVersion.            | `v0.3.0-rc0`                       |
...
| `controller.image.tag`                                    | The image tag of egressgateway controller, overrides the image tag whose default is the chart appVersion.                            | `v0.3.0-rc0`                            |
