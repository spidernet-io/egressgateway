...
| `egressgatewayAgent.image.tag`                                    | The image tag of egressgateway agent, overrides the image tag whose default is the chart appVersion.      | `""`                               |
...
| `egressgatewayController.image.tag`                                    | The image tag of egressgatewayController, overrides the image tag whose default is the chart appVersion.                             | `""`                                    |
