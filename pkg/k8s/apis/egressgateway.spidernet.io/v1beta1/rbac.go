...
// +kubebuilder:rbac:groups=egressgateway.spidernet.io,resources=egressgateways;egressnodes;egressclustergatewaypolicies;egressgatewaypolicies;egressendpointslice;egressclusterinfos,verbs=get;list;watch;create;update;patch;delete
