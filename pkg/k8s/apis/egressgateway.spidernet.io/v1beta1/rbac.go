...
// +kubebuilder:rbac:groups=egressgateway.spidernet.io,resources=egressgateways;egressnodes;egressclustergatewaypolicies;egressgatewaypolicies;egressendpointslices;egressclusterendpointslices;egressclusterinfos,verbs=get;list;watch;create;update;patch;delete
