...
// +kubebuilder:rbac:groups=egressgateway.spidernet.io,resources=egressgateways,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=egressgateway.spidernet.io,resources=egressgateways/status,verbs=get;update;patch
