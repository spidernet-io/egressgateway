...
type Action interface {
	ToFragment(features *Options) string
}
...
func (g GotoAction) ToFragment(features *Options) string {
...
func (g JumpAction) ToFragment(features *Options) string {
...
func (r ReturnAction) ToFragment(features *Options) string {
	return "--jump RETURN"
}
...
func (g DropAction) ToFragment(features *Options) string {
	return "--jump DROP"
}
...
func (g RejectAction) ToFragment(features *Options) string {
	return "--jump REJECT"
}
...
func (g LogAction) ToFragment(features *Options) string {
...
func (g AcceptAction) ToFragment(features *Options) string {
	return "--jump ACCEPT"
}
...
func (g DNATAction) ToFragment(features *Options) string {
	if g.DestPort == 0 {
...
func (g SNATAction) ToFragment(features *Options) string {
	fullyRand := ""
...
func (g MasqAction) ToFragment(features *Options) string {
	fullyRand := ""
...
func (c ClearMarkAction) ToFragment(features *Options) string {
...
func (c SetMarkAction) ToFragment(features *Options) string {
...
func (c SetMaskedMarkAction) ToFragment(features *Options) string {
...
func (g NoTrackAction) ToFragment(features *Options) string {
	return "--jump NOTRACK"
}
...
func (c SaveConnMarkAction) ToFragment(features *Options) string {
	var mask uint32
	if c.SaveMask == 0 {
...
func (c RestoreConnMarkAction) ToFragment(features *Options) string {
	var mask uint32
	if c.RestoreMask == 0 {
...
func (c SetConnMarkAction) ToFragment(features *Options) string {
	var mask uint32
	if c.Mask == 0 {
