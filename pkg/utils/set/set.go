...
//
// Based on https://github.com/projectcalico/calico/blob/eb0e4ca98cfee2a9d968e8abdb09d72ddca6d8a5/libcalico-go/lib/set/set.go
...
loop:
	for item := range set {
		...
		case nil:
		default:
			panic(fmt.Sprintf("Unexpected iteration error: %v", err))
		}
	}
}
