...
# usage:
#  GH_TOKEN=${{ github.token }} LABEL_FEATURE="release/feature-new" LABEL_BUG="release/bug" PROJECT_REPO="spidernet-io/egressgateway" changelog.sh ./ v0.3.6  "spidernet-io/egressgateway"
#  GH_TOKEN=${{ github.token }} LABEL_FEATURE="release/feature-new" LABEL_BUG="release/bug" PROJECT_REPO="spidernet-io/egressgateway" changelog.sh ./ v0.3.6 v0.3.5  "spidernet-io/egressgateway"
...
# optional
START_TAG=${3:-""}
GITHUB_REPO=${4:-"spidernet-io/egressgateway"}
